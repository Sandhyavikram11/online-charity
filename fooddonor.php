...
{	
	...
	{
		$sql ="UPDATE food_donor set donor_id='$_POST[donor_id]',address='$_POST[address]',city='$_POST[city]',pin_code='$_POST[pin_code]',food_item_detail='$_POST[food_item_detail]',quantity='$_POST[quantity]',status='$_POST[status]',datetime='$_POST[datetime]','$_POST[Drywaste]' WHERE food_donor_id='$_GET[editid]'";
	...
	{
		$sql ="INSERT INTO food_donor(donor_id,address,city,pin_code,food_item_detail,quantity,status,datetime,drywaste) VALUES('$_SESSION[donor_id]','$_POST[address]','$_POST[city]','$_POST[pin_code]','$_POST[food_item_detail]','$_POST[quantity]','Pending','$_POST[datetime]','$_POST[Drywaste]')";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) == 1)
		{
...
<br>
<div class="row">
	<div class="col-md-2" style="padding-top: 5px;">Drywaste  </div>
	<div class="col-md-10">
		<textarea name="Drywaste"  id="Drywaste" class="form-control" rows="6" ><?php echo $rsedit['Drywaste']; ?></textarea>
	<span id="errDrywaste" class="errorclass"></span>
	</div>
</div>
...
function validateform()
{
	...
	if(document.getElementById("Drywaste").value == "")
	{
		document.getElementById("errDrywaste").innerHTML = "Drywaste should not be empty..";
		i=1;
	}	
